...
class DQNAgent:
    ...
    def act(self, state: Array3D, allowed_rows: list, allowed_cols: list) -> Tuple[int, int]:
        ...
        # Use argmax to choose the best allowed action
